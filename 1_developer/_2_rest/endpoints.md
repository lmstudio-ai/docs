...
```bash
curl -H "Authorization: Bearer <GENERATED_LM_API_TOKEN>" http://localhost:1234/api/v0/models
```
...
```bash
curl -H "Authorization: Bearer <GENERATED_LM_API_TOKEN>" http://localhost:1234/api/v0/models/qwen2-vl-7b-instruct
```

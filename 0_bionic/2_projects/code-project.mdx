...
<img
  ...
  data-caption="Bionic can inspect local codebases, explain unfamiliar code, and help you make changes."
  style={{ width: "100%", marginTop: "16px" }}
/>

<p className="text-fd-muted-foreground mt-2 text-center text-sm">Bionic can inspect local codebases, explain unfamiliar code, and help you make changes.</p>

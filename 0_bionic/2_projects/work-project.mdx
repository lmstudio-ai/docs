...
<img
  ...
  data-caption="Give Bionic documents to work with, or ask it to generate new documents, decks, spreadsheets, and more from scratch."
  style={{ width: "100%", marginTop: "16px" }}
/>

<p className="text-fd-muted-foreground mt-2 text-center text-sm">Give Bionic documents to work with, or ask it to generate new documents, decks, spreadsheets, and more from scratch.</p>

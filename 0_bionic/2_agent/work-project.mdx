...
For document work, Bionic gives you a managed sandbox for iterating on documents and other files. Use one project for work that should share the same goal and the same **Project Files**, which appear in the right sidebar.

...
Hermes Agent now supports LM Studio as a first class local model provider. It comes with JIT loading with higher context length (64K) and reasoning effort support.

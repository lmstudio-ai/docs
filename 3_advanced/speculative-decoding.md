...
> 🔔 Speculative decoding requires LM Studio 0.3.10 or newer, [get it here](https://lmstudio.ai/download)
...
<img src="/assets/docs/speculative-decoding-setting.png" style="width:80%; margin: 20px;" data-caption="The Speculative Decoding section of the chat sidebar">

If you see the following when you open the dropdown:
...
Speculative decoding speed-up is generally dependant on two things:
1. How fast the draft model is compared to the main model
2. How often the draft model makes "good" suggestions
...
The key to faster generation of the main model is choosing a draft model that's both quick and accurate enough that its benefits to the main model exceed the computational resources it consumes.

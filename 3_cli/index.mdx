...
It is possible to use the `--host` and `--port` flags on any `lms` subcommand to connect to a remote instance of LM Studio. This feature does not use end-to-end encryption and is distinct from [LM Link](./docs/lmlink/index).
